...
class ListViewUI:
    ...
    def create_listview(self):
        if self.__created:
            ...
            # 定义listview
            self.tree = ttk.Treeview(self.frame, columns=self.head_tags, show='headings')
